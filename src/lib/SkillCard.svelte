	...
	<h4 class="flex flex-row items-center justify-between text-nowrap text-lg sm:pl-4 md:text-3xl">
		...
		<div class="flex-0">
			{#if state === 'active'}
				...
				>
					<path d="M7 12.5L10 15.5L17 8.5" stroke-linecap="round" stroke-linejoin="round"></path>
					<path
			...
			{:else if state === 'learning'}
				...
				>
					<path d="M8.5 16.5L12 13L15.5 16.5" stroke-linecap="round" stroke-linejoin="round"></path>
					<path d="M8.5 10.5L12 7L15.5 10.5" stroke-linecap="round" stroke-linejoin="round"></path>
					<path
						d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"
						stroke-linecap="round"
						stroke-linejoin="round"
